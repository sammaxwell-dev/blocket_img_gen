...
**Результат (Deliverable):** Фото проходят через AI и становятся "готовыми к Blocket".
...
### Задача 3.1: Authentication
*Персонализация и личный кабинет*

| Подзадача | Оценка | Статус |
|-----------|--------|--------|
| [ ] NextAuth.js setup | 2h | [ ] |
| [ ] Google OAuth интеграция | 2h | [ ] |
| [ ] Email Magic Link (через Resend/SendGrid) | 2h | [ ] |
| [ ] Таблица пользователей в Postgres | 1h | [ ] |
| [ ] UI: страницы входа и профиля | 2h | [ ] |
